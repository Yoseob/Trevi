...
//! Project version number for Trevi.
FOUNDATION_EXPORT double TreviVersionNumber;

//! Project version string for Trevi.
FOUNDATION_EXPORT const unsigned char TreviVersionString[];
